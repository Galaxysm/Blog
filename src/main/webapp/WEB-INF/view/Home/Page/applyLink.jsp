                        ...
                        <form class="layui-form layui-form-pane" id="applyLinkForm"  method="post">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="linkName"  placeholder="如：百度" class="layui-input" required>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">网站地址</label>
                                <div class="layui-input-block">
                                    <input type="url" name="linkUrl"  placeholder="如：www.baidu.com" class="layui-input" required>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">网站描述</label>
                                <div class="layui-input-block">
                                    <input type="text" name="linkDescription" placeholder="如：全球最大的中文搜索引擎" class="layui-input" required>
                                </div>
                            </div>
